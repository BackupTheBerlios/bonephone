...
public abstract class SDPObject extends GenericObject  {
	...
	protected void initSprint() { super.stringRepresentation = ""; }

	protected String getStringRepresentation() 
		{ return super.stringRepresentation; }

	public void setInputText(String txt) { super.setInputText(txt); }
	   ...
	   for (int i = 0; i < fields.length; i++) {
		...
		try {
		  ...
		  if (fieldType.isPrimitive()) {
			...
			System.out.println("Cound not find " + 
				ex.getMessage());
			ex.printStackTrace();
			System.exit(0);	
		}
