...
class transport_Lexer extends Lexer;
	 ...
	 /**
        ...
        */
        ...
        if (! keywordsInitialized)  {
                ...
                addKeyword(TCP, URIKeywords.TCP);
                addKeyword(UDP, URIKeywords.UDP);
                addKeyword(PHONE, URIKeywords.PHONE);
                addKeyword(IP, URIKeywords.IP);
