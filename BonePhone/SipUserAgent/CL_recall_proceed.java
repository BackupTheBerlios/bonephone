/*
*
* $Id: CL_recall_proceed.java,v 1.1 2002/02/04 13:23:31 Psycho Exp $
*
...
/**
* class CL_recall_proceed
*
* @version	$Revision: 1.1 $
* @author	$Author: Psycho $
**/
final class CL_recall_proceed extends CallLeg.State
{
	private static final CL_recall_proceed singleton = new CL_recall_proceed();
	
	private CL_recall_proceed()
	{
	}
	
	static CallLeg.State getState()
	{
		System.out.println("CallLeg.State = CL_recall_proceed");
		return singleton;
	}
